...
def get_means_stds_missing_values(training_years: List[int]):
    ...
    stats_per_training_year_combo = {
        (2018, 2019): {
        # 'means': np.array([0.187428, 0.350051, 0.222269, 0.446445, 0.290878, 1.865067, 3.300430, 158.322311, 226.390076, 237.223358, 33.827297, 0.007448, 2.724406, 132.406784, -1571.405640, 1.104967, 0.0, 0.335005, 2.633165, 2.513559, 21.527756, 0.010776, 1.48318570e+01], dtype=np.float32),
        # 'stds': np.array([0.105364, 0.181421, 0.221190, 0.143892, 0.102308, 4.584773, 1.431865, 66.890533, 23.379213, 24.736614, 8.780910, 0.002174, 2.356086, 71.701324, 601.775940, 0.887756, 0.0, 0.913537, 1.098657, 43.644825, 2.153302, 0.001353, 5.52618558e+00], dtype=np.float32),
        'means': np.array([
